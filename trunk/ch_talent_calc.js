...
function calc(){
	...
	document.autoSumForm.AutoDmgCalc.value = Math.round((((0.15818 * Math.sqrt(StrAutoCalc)) + (0.061069 * Math.sqrt(Weapon Ability)) + 0.96523) * Number(PhysicalDamage)) + Number(ElementalDamage);
